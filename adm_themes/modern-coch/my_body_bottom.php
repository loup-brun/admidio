...
<p id="copyright">
    ...
    <span style="font-size: 9pt; padding-left: 8px;">&copy; 2004 - 2018&nbsp;&nbsp;<?php echo $gL10n->get('SYS_ADMIDIO_TEAM'); ?></span><br />
    <span style="font-size: 9pt; padding-left: 8px;">Administration : <a href="mailto:louis@corsaire-chaparral.org">Louis-Olivier Brassard</a></span>
</p>
